...
namespace Oculus.Interaction
{
    ...
    public class InteractableUnityEventWrapper : MonoBehaviour
    {
        ...
        [SerializeField]
        private GameObject _targetObject; // Assign the target GameObject in the Inspector

        private bool _isToggled = false;
        public void Toggle()
        {
            _isToggled = !_isToggled;
            _targetObject.SetActive(_isToggled); // Activate or deactivate the GameObject based on toggle state
